...
T = [
    ...
    ('<h4>Power BI dashboard <span class="tag tag-accent">In progress</span></h4>', '<h4>لوحة Power BI <span class="tag tag-accent">قيد التنفيذ</span></h4>'),
    ('Star schema with personal data removed, 27 DAX measures, a report theme and four page designs — verified against independently computed values. Report build under way.',
     'نموذج Star Schema خالٍ من البيانات الشخصية، و27 مقياس DAX، وقالب ألوان، وتصاميم لأربع صفحات — مُتحقَّق منها مقابل قيم محسوبة بشكل مستقل. بناء التقرير جارٍ.'),
