...
T = [
    ...
    # Smart City
    ('aria-label="View the Smart City entity relationship diagram"', 'aria-label="عرض مخطط علاقات الكيانات لمشروع المدينة الذكية"'),
    ('alt="Entity relationship diagram for the Smart City Management System"', 'alt="مخطط علاقات الكيانات لنظام إدارة المدينة الذكية"'),
    ('</svg> View ERD</span>', '</svg> عرض المخطط</span>'),
    ('<span class="tag tag-primary">Database Design · SQL</span>', '<span class="tag tag-primary">تصميم قواعد البيانات · SQL</span>'),
    ('<span class="tag">Team Project · 2025</span>', '<span class="tag">مشروع جماعي · 2025</span>'),
    ('<h3>Smart City Management System</h3>', '<h3>نظام إدارة مدينة ذكية</h3>'),
    ('A relational database course project unifying incident reports, parking, and IoT sensors for a city.',
     'مشروع لمادة قواعد البيانات العلائقية يوحّد بلاغات الأعطال ومواقف السيارات وحساسات إنترنت الأشياء لمدينة واحدة.'),
    ('Local governance bodies typically run incident reporting, parking capacity, and IoT sensor readings as disconnected datasets — slowing response to civic issues and wasting parking capacity.',
     'عادة ما تدير الجهات الحكومية المحلية بلاغات الأعطال وسعة المواقف وقراءات حساسات إنترنت الأشياء كبيانات منفصلة — مما يبطئ الاستجابة للمشكلات المدنية ويهدر سعة المواقف.'),
    ('Worked with three teammates to design and build the system end to end for a Database Concepts &amp; Design course — conceptual ERD, a normalized relational schema, physical DDL with real constraints, and a working CRUD application on top of it.',
     'عملت مع ثلاثة زملاء لتصميم وبناء النظام من الألف إلى الياء لمادة مفاهيم وتصميم قواعد البيانات — مخطط ERD مفاهيمي، ومخطط علائقي مُطبَّع، وأوامر DDL فعلية بقيود حقيقية، وتطبيق CRUD يعمل فوقها.'),
    ('Modeled a 10-entity ERD (citizens, reports, locations, parking, sensors) into a 10-table relational schema with primary/foreign keys, NOT NULL constraints and cascading deletes',
     'حوّلت مخطط ERD من 10 كيانات (مواطنون، بلاغات، مواقع، مواقف، حساسات) إلى مخطط علائقي من 10 جداول بمفاتيح أساسية وأجنبية، وقيود NOT NULL، وحذف متسلسل'),
    ('Wrote 10 Oracle SQL queries — multi-table joins, aggregation with GROUP BY, and a nested subquery',
     'كتبت 10 استعلامات Oracle SQL — ربط عدة جداول، وتجميع بـGROUP BY، واستعلام فرعي متداخل'),
    ('Built a CRUD web app in Oracle APEX with dedicated pages for citizens, locations, sensors and parking, backed directly by the schema',
     'بنيت تطبيق ويب CRUD بواسطة Oracle APEX بصفحات مخصصة للمواطنين والمواقع والحساسات والمواقف، مرتبطة مباشرة بمخطط قاعدة البيانات'),
    ('<span class="chip">ERD &amp; Relational Modeling</span><span class="chip">Oracle SQL</span><span class="chip">PL/SQL</span><span class="chip">Oracle APEX</span>',
     '<span class="chip">ERD وتصميم علائقي</span><span class="chip">Oracle SQL</span><span class="chip">PL/SQL</span><span class="chip">Oracle APEX</span>'),
    ('Built with Mohammed Alghafli, Hadi Almubarak and Abdullah Alghadeer — King Faisal University.',
     'بالتعاون مع محمد الغافلي وهادي المبارك وعبدالله الغديّر — جامعة الملك فيصل.'),
    ('</svg> Read the Full Report</a>', '</svg> اقرأ التقرير كاملاً</a>'),
    # Graduation project
